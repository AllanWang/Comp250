...
public class Tester1 {
	...
	public static void main(String[] args) throws Exception {
		...
		//  You can test the correctness of your A1.NaturalNumber implementation
...
//		String s2 = "23";
		...
		//  The BigInteger class uses an 'add' method for addition, but A1.NaturalNumber
		...
		System.out.println(n1.plus(n2));                     // A1.NaturalNumber

		//  The BigInteger class uses a 'subtract' method for addition, but A1.NaturalNumber
		...
		System.out.println(n1.minus(n2));                         // A1.NaturalNumber

		//  The BigInteger class uses a 'multiply' method for addition. A1.NaturalNumber
		//  uses 'times' instead.  
		...
		System.out.print("slow multiply: n1*n2  = ");               // A1.NaturalNumber
		...
		System.out.print("slow divide: n1/n2    = ");               // A1.NaturalNumber
